...
Reproduce the results presented in **Table 2** of the paper: S. Liu and A. Sakzad, “On the Maximum Toroidal Distance Code for Lattice-Based Public-Key
...
- MTD_2D_Codes_(optimized 2D Minal Codes).py
  ...
  - Runtime: Roughly few minutes on standard hardware
...
- GTD_4D_Codes_(based on the D4 lattice).py
  ...
  - Runtime: Roughly 1-2 hours on standard hardware
- GTD_8D_Codes_(based on the E8 lattice).py
  - The DFR of the proposed **8D GTD codes**
  - Runtime: Roughly 1-2 days on standard hardware
