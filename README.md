...
-GTD_8D_Codes_(based on the E8 lattice).py
 ...
 - The 240 root vectors (or Voronoi vectors {v_i}) for 2*E8 lattice are used to compute the distribution D_i=Pr{<x_i,v_i>} and the correspoinding DFR per codeword
